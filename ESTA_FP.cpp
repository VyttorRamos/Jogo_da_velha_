...
//Esta Struct possui todos as funções e elementos necessario para um bom desempenho da estrututra de FILA.
struct Fila_struct{
...
//Esta Struct possui todos as funções e elementos necessario para um bom desempenho da estrututra de PILHA.
struct Pilha_struct{
    int Pilha[50];
